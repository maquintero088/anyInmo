 ...
 * 
 */
function iniciarSpinnerLite(){
	
	var code=document.createElement('div');
	code.setAttribute('style','width:100%;height:100%;position:fixed;background:#fffc;z-index:10000000;top:0;');
	code.setAttribute('id','spinner-div');
	code.setAttribute('class','text-center');
	code.innerHTML="<br/><br/><h1><strong style='color:#00BDF3'>Loading...</strong></h1>";
